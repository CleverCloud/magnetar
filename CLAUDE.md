...
cargo run -p xtask -- check-sim-coverage        # patch coverage on diff over the 8 crates the sim run compiles; ENFORCING — an uncovered added line fails (ADR-0024, ADR-0088, ADR-0090, ADR-0092, ADR-0102)
