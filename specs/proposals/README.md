...
| ----------------------------------------------------------------- | -------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [PIP-460](pip-460-scalable-topics.md)                             | Scalable topics / DAG-watch consumer (experimental)                                    | [ADR-0031](../adr/0031-pip-460-scalable-subscription-scope.md) → [ADR-0093](../adr/0093-pip-460-upstream-wire-surface.md) → [ADR-0098](../adr/0098-assignment-driven-m1-hardened-stream-consumer.md) | Historical      | 🟡 **LIVE on a milestone.** Upstream shipped PIP-460 in `v5.0.0-M1`; ADR-0093 governs the vendored wire, and ADR-0098 supersedes this proposal's surviving drop-on-change scope. The guessed wire sections remain design history.                                                  |
...
| [M1-hardened StreamConsumer](feat-m1-hardened-stream-consumer.md) | Assignment-driven segment fan-out, ordering, concurrent receive, and follow-up closure | [ADR-0098](../adr/0098-assignment-driven-m1-hardened-stream-consumer.md)                                                                                                                             | In-flight       | 🟡 **LIVE on a milestone, with tracked upstream gaps.** The feature-branch implementation targets `v5.0.0-M1`; real-M1 execution, committed-diff sim coverage, and the full acceptance chain remain pending, while apache/pulsar#26272-#26275 stay explicitly bounded by ADR-0098. |
