...
| [M1-hardened StreamConsumer](feat-m1-hardened-stream-consumer.md) | Assignment-driven segment fan-out, ordering, concurrent receive, and follow-up closure | [ADR-0093](../adr/0093-pip-460-upstream-wire-surface.md) + pending implementation ADR                                     | Draft           | 🟡 **LIVE on a milestone, with tracked upstream gaps.** The data plane and assignment surface ship in `v5.0.0-M1`; controller fencing, pooled unregister, complete DAG ordering, and proxy controller routing remain tracked in apache/pulsar#26272-#26275. |
