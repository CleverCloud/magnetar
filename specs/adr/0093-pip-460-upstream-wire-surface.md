...
- **Status**: Accepted (layout-epoch handling amended by [ADR-0095](0095-ignore-a-re-sent-scalable-layout-epoch.md); high-level data-plane scope and consumer-assignment epoch handling amended by [ADR-0102](0102-assignment-driven-m1-hardened-stream-consumer.md))
- **Date**: 2026-08-03
