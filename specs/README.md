...
| [0036](adr/0036-moonpool-seed-sweep-daily-random.md) | Moonpool seed sweep: daily 16-random-seed sweep in a dedicated workflow, drop per-PR fixed 32-seed matrix — amends ADR-0024 §3 (CI cadence) | Amended by [ADR-0043](adr/0043-temporary-floating-moonpool-git-dep.md) (exact-pin scoped exception) |
