...
pub struct QueueConsumerBuilder<'a> {
...
impl std::fmt::Debug for QueueConsumerBuilder<'_> {
...
impl<'a> QueueConsumerBuilder<'a> {
    ...
    pub async fn subscribe(self) -> Result<QueueConsumer, crate::PulsarError> {
