...
//!
//! `magnetar-runtime-tokio` does NOT depend on `magnetar-messagecrypto` directly — that
//! crate pulls in `aws-lc-rs`, which is heavy. Instead the producer / consumer hold an
