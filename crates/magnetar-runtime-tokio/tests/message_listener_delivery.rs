...
//! Push-delivery (`MessageListener`) drain semantics — the tokio mirror of
...
//! driven through this engine's [`magnetar_runtime_tokio::ConnectionShared`]
...
//! behaviour under the deterministic-simulation engine.
