...
//! and no Docker; the mirrored `magnetar-runtime-moonpool` file pins the identical behaviour
//! against the deterministic-simulation engine, keeping the runtime 1:1 test count (ADR-0024).
