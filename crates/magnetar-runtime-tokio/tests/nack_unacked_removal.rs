...
//! Tokio sibling of the moonpool `nack_unacked_removal` test (ADR-0024 1:1
//! runtime-test-parity). A message that is BOTH negatively acknowledged AND
...
//! 2. Feed a synthetic broker `CommandMessage` at synthetic t0 — the unacked tracker records it.
