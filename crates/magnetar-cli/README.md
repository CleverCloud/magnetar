...
They get implemented once the [`Connection`](https://github.com/CleverCloud/magnetar) state machine and the tokio engine are integrated into the `magnetar` façade.
