...
//! churn-window guard that must NOT be mistaken for it (issue #349). The
//! moonpool mirror of `magnetar-runtime-tokio/tests/receiver_queue_auto_growth.rs`.
//!
...
//! unit as it arrives). This file drives that split through the moonpool
//! engine's public [`magnetar_runtime_moonpool::ConnectionShared`] surface (no
