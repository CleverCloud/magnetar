...
//! Wrapper push-delivery (`WrapperMessageListener`) drain semantics — the moonpool
//! mirror of `magnetar-runtime-tokio/tests/wrapper_message_listener_delivery.rs`.
//!
...
//!
//! No driver task, no TCP listener, no wall clock. The tokio sibling pins the
//! identical behaviour against the tokio engine.
