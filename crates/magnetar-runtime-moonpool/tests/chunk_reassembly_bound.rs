...
//! Moonpool sibling of the tokio `chunk_reassembly_bound` test (ADR-0024 1:1
...
//!
//! Both engines wrap the SAME `magnetar_proto::Connection`; the moonpool engine
//! pins it on a virtual clock so the eviction walk is bit-for-bit reproducible
//! across seeds.
//!
