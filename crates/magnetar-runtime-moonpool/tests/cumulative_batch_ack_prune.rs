...
//! Moonpool sibling of the tokio `cumulative_batch_ack_prune` test (ADR-0024 1:1
...
//! sans-io state machine through this engine's `ConnectionShared` — no listener,
//! no wall clock, no Docker.
//!
//! ## Shape
//!
