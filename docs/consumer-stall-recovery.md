...
This page is the operator-facing form of [ADR-0101](../specs/adr/0101-consumer-stall-detection-and-in-place-recovery.md) — what the symptom looks like, how to detect it from the client, and the recovery ladder.
...
> Correlate before acting (next section). This is also why the watchdog never recovers on its own.
