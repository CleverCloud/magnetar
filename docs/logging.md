...
| `info!`  | Lifecycle: one record per state change or unit of work.                                                   | Connection established; producer/consumer created or closed; reconnect success + state replay; failover swap; dead-letter republish summary. |
