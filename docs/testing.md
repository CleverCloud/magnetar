...
| [`e2e_reconnect_safety.rs`](../crates/magnetar/tests/e2e_reconnect_safety.rs)                   | Frame-aware cuts before/after producer-batch flush, conservative PIP-54 `ack_set` reconstruction with the broker feature enabled, and broker-authoritative durable reattach cursors (issues #395, #396, #398; ADR-0096).                                                                                                                         |
