...
| [`stream_consumer_equivalence.rs`](../crates/magnetar-differential/tests/stream_consumer_equivalence.rs)                                     | Nine baseline public scalable-aggregate scenarios: typed delivery, concurrent receive and atomic batch, aggregate budget, same-epoch assignment and drain, child reconnect, acknowledgement retry, negative-ack redelivery, close wakeup, and public builder/position/transaction/drop surfaces (ADR-0098).                                     |
| [`stream_consumer_advanced_equivalence.rs`](../crates/magnetar-differential/tests/stream_consumer_advanced_equivalence.rs)                   | Thirteen advanced public scalable-aggregate scenarios spanning ancestry, M1 sealed-assignment limits, ordering modes, seek/resynchronization, transactions and cancellation, controller ordering/recovery, compressed batch/chunk delivery, child-open and close lifecycle, malformed delivery, and partial acknowledgement failure (ADR-0098). |
